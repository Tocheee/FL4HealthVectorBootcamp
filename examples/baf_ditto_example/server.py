...
def main(config: dict[str, Any]) -> None:
    ...
    initial_model =  MLPNet2(input_dim=input_dim)
    ...
    server = DittoServer(client_manager=client_manager, 
    fl_config=config, 
    strategy=strategy, 
    reporters=reporters,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="examples/baf_ditto_example/config.yaml",
    )
